...
- [ ] I separated source observation, proposed translation, and project hypothesis where applicable.
- [ ] New or changed empirical claims have stable `C-` IDs, scoped evidence status, primary sources, and explicit boundary conditions.
- [ ] New mechanisms were checked against existing `P-` bundles and the strongest ordinary engineering null.
...
<!-- Paste the exact commands run and their outcomes. Explain any command not run. -->
