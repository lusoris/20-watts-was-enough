...
| Highest coverage tier | Claims | Share of 1550 | Meaning |
| --- | ---: | ---: | --- |
...
| protocol-complete test contract | 1458 | 94.1% | at least one linked artifact contains all eight required facets |
| workstation-executable | 0 | 0.0% | checked execution manifest and runnable scientific harness exist |

The short answer is therefore **1458 claims have a complete
test description, but 0 are executable on the workstation**.
Across both description tiers, 1458 claims have an exact direct
...
| protocol-complete | 1132 | 210 | 60 | 47 | 9 |
...
The union yields 1458 linked claims: 1241
