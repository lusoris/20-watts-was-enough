...
| F-029 | [Clinical-biotechnology endogenous-machinery transfers](029-clinical-biotechnology-endogenous-machinery.md) | recruited maintenance, sparse typed correction, reversible latent-path selection, and phase-qualified preservation/release; four protocol-complete specification-only contracts for C-1574/C-1576/C-1578/C-1580, with C-1573/C-1575/C-1577/C-1579 retained as source-domain evidence inputs and no runner, manifest, result, or workstation-execution claim |
