...
| relative sensing and scale symmetry | full-trajectory invariance, adaptation, peak equality, static normalization, interface-specific statistics, finite support, reference lifecycle, collective transport, and observation-dependent recoverability remain distinct; [Fixture F-026](../experiments/fixtures/026-interface-qualified-relative-sensing.md) carries [C-1540](../research/claims.md#c-1540)–[C-1549](../research/claims.md#c-1549) and the [scale-symmetry contract](../math/interface-qualified-scale-symmetry.md) without promoting a principle or candidate |
