...
| --- | --- | --- |
| plant distributed control | when do electrical, hydraulic, chemical, growth, and source–sink responses implement genuinely distinct distributed resource control? | split organism-level control from ecosystem interaction and test P-002/P-006/P-009/P-012 |
| astronomy and planetary remote inference | which survey-design, selection-correction, inverse-problem, and time-domain alert mechanisms change active observation under irreducible distance? | test P-001/P-007/P-013 against statistical inference and sensor-allocation nulls |
| geology and geomorphology | when do fracture, drainage, erosion, and transport networks provide usable adaptive topology rather than passive path-dependent optimization? | test P-005/P-006/P-010 against materials, network, and Earth-system nulls |
