...
markdown.push(
  ...
  "## Next gap wave",
  "",
  "1. **Subfield resolution inside green cells:** sample individual DFG subjects and ANZSRC groups in food chemistry, marine and atmospheric process science, structural biology, physiology, environmental treatment, health implementation, and applied mathematics; an entry audit does not close its parent field.",
