...
| `THERMO-025` | established | Continuous-valued physical computation does not provide free infinite precision; dynamic range, thermal and device noise, drift, calibration, conversion, and error tolerance determine useful bits. | [sparse predictive compute](../../concept/30-sparse-predictive-compute.md), [energy](../../concept/80-energy-model.md) | [Sarpeshkar 1998](https://doi.org/10.1162/089976698300017052); [Diamantini, Trugenberger, and Vinokur 2016](https://doi.org/10.1103/PhysRevE.94.012139) |
