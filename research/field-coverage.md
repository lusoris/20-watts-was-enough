...
The OECD baseline contains **42 second-level fields**. The repository has a dedicated audit for **38 (90.5%)**, adjacent evidence without a field-centered audit for **4 (9.5%)**, and no durable review for **0 (0.0%)**.
