...
- **Statement:** An image or sensor tensor is generated by a physical operator, noise process, and acquisition policy; reconstructing a latent scene therefore requires those states or assumptions about them.
- **Status:** established.
- **Primary sources:** `Fienup1982PhaseRetrieval`, `AntipaEtAl2018DiffuserCam`, `AhmedEtAl2014BlindDeconvolution`.
- **Rationale:** phase retrieval, lensless imaging, and blind deconvolution make operator dependence explicit without licensing removal of acquisition metadata.
- **Open issue:** how much of a high-dimensional operator can be compacted while preserving every downstream query of interest.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md), [Candidate 017](../experiments/candidates/017-contract-preserving-semantic-compaction.md), [Candidate 018](../experiments/candidates/018-value-reconstructability-aware-tiering.md).

### C-971

- **Statement:** Wavelength, aperture, field of view, sampling, coherence, and noise jointly limit distinguishable spatial modes; pixel count alone does not measure recoverable information.
- **Status:** established.
- **Primary sources:** `CoxSheppard1986InformationCapacity`, `Miller2000SpatialChannels`, `DonohoStark1989Uncertainty`.
- **Rationale:** space–bandwidth and communication-mode analyses bound orthogonal channels, while uncertainty results expose concentration tradeoffs in conjugate domains.
- **Open issue:** task-specific decisions can require fewer modes than faithful reconstruction, with limits depending on scene and loss distribution.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 001](../experiments/candidates/001-adaptive-topology.md), [Candidate 017](../experiments/candidates/017-contract-preserving-semantic-compaction.md).

### C-972

- **Statement:** If two admissible states produce the same likelihood under the calibrated operator, observations cannot distinguish them without an added prior, intervention, or measurement.
- **Status:** established.
- **Primary sources:** `DonohoStark1989Uncertainty`, `BruckSodin1979Ambiguity`, `CandesEtAl2006StableRecovery`.
- **Rationale:** nonuniqueness is structural; a generator may select a plausible representative but cannot convert that selection into measurement evidence.
- **Open issue:** compact, intelligible summaries of task-relevant equivalence classes rather than enormous null-space bases.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 007](../experiments/candidates/007-endogenous-observation-surveillance.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md), [Candidate 017](../experiments/candidates/017-contract-preserving-semantic-compaction.md).

### C-973

- **Statement:** Under independent Poisson detection, signal grows linearly with expected detected photons while standard deviation grows as its square root.
- **Status:** established.
- **Primary sources:** `OberEtAl2004Localization`, `SharmaPiestun2010Localization`, `WeiEtAl2020Ptychography`.
- **Rationale:** Fisher-information and localization studies quantify limits under explicit photon models but do not make every detector Poisson-limited.
- **Open issue:** background, coherent noise, dark current, read noise, afterpulsing, and temporal correlations dominate different regimes.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 007](../experiments/candidates/007-endogenous-observation-surveillance.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md).

### C-974

- **Statement:** Fisher information and Cramér–Rao bounds quantify precision only for the declared likelihood, parameterization, action, and estimator class.
- **Status:** established.
- **Primary sources:** `OberEtAl2004Localization`, `SharmaPiestun2010Localization`, `TsangEtAl2016QuantumSuperresolution`.
- **Rationale:** engineered measurements can change information, but misspecification and nuisance parameters change the attainable bound.
- **Open issue:** tractable bounds for learned, nonparametric scenes under operator uncertainty.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 007](../experiments/candidates/007-endogenous-observation-surveillance.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md).

### C-975

- **Statement:** Changing illumination time, angle, spectrum, phase, or pattern can alter identifiability and task information; improvement must be charged to photons, dose, actuation, time, and inference.
- **Status:** established.
- **Primary sources:** `VeltenEtAl2012AroundCorner`, `KirmaniEtAl2014FirstPhoton`, `Fienup1982PhaseRetrieval`.
- **Rationale:** time-resolved and structured measurements reveal dimensions absent from passive intensity frames by spending active-source and calibrated-code resources.
- **Open issue:** learned policies may exploit simulator errors or unsafe exposure shortcuts unless dose and physical coverage are constrained.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 007](../experiments/candidates/007-endogenous-observation-surveillance.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md).

### C-976

- **Statement:** Recovery from fewer linear measurements is guaranteed only when the signal class and measurement ensemble satisfy stated sparsity, incoherence, restricted-isometry, noise, or related conditions.
- **Status:** established.
- **Primary sources:** `Donoho2006CompressedSensing`, `CandesEtAl2006StableRecovery`, `DuarteEtAl2008SinglePixel`.
- **Rationale:** compressed sensing replaces exhaustive coefficient sampling with structural assumptions rather than producing assumption-free compression.
- **Open issue:** approximately sparse, dynamic, or distribution-shifted scenes can violate the stated conditions.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md), [Candidate 017](../experiments/candidates/017-contract-preserving-semantic-compaction.md), [Candidate 018](../experiments/candidates/018-value-reconstructability-aware-tiering.md).

### C-977

- **Statement:** Intensity-only measurements discard phase and can leave global phase, shift, conjugate-reflection, factorization, or support ambiguities unless measurement diversity and constraints remove them.
- **Status:** established.
- **Primary sources:** `BruckSodin1979Ambiguity`, `Fienup1982PhaseRetrieval`, `CandesEtAl2015WirtingerFlow`.
- **Rationale:** algorithmic convergence remains distinct from uniqueness, global optimality, and physical fidelity.
- **Open issue:** practical identifiability under Poisson noise, partial coherence, unknown support, and calibration error is system-specific.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 007](../experiments/candidates/007-endogenous-observation-surveillance.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md), [Candidate 017](../experiments/candidates/017-contract-preserving-semantic-compaction.md).

### C-978

- **Statement:** Masks, diffusers, coded pupils, or illumination can encode scene variables for computational recovery, exchanging optical thickness or mechanics for calibration, compute, priors, photons, and artifacts.
- **Status:** established.
- **Primary sources:** `FenimoreCannon1978CodedAperture`, `AsifEtAl2015FlatCam`, `AntipaEtAl2018DiffuserCam`.
- **Rationale:** physical encoding and digital inversion form one instrument; a thinner front end is not automatically more informative or efficient.
- **Open issue:** learned co-design often underrepresents manufacturing and environmental shift in simulation and training data.
...
- **Statement:** STED, PALM, and STORM obtain sub-diffraction localization or structure through nonlinear depletion, photoswitching, sparse activation, and repeated acquisitions; they do not recover arbitrary lost frequencies from one ordinary passive frame.
- **Status:** established.
- **Primary sources:** `HellWichmann1994STED`, `BetzigEtAl2006PALM`, `RustEtAl2006STORM`.
- **Rationale:** distinguishability is created through controlled photophysics and time, so dose, labeling, drift, density, and sample dynamics are part of the result.
- **Open issue:** the relevant boundary depends on whether the task values localization, topology, morphology, live dynamics, or appearance.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 006](../experiments/candidates/006-reversible-physical-skill.md), [Candidate 007](../experiments/candidates/007-endogenous-observation-surveillance.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md).

### C-980

- **Statement:** Stable recovery beyond a measured bandwidth requires restrictions such as sparsity, positivity, separation, repeated shifted views, or a learned distribution; performance collapses where those restrictions fail.
- **Status:** established.
- **Primary sources:** `Donoho1992Superresolution`, `CandesFernandezGranda2014SuperResolution`, `MorgenshternCandes2016PositiveSuperResolution`.
- **Rationale:** mathematical guarantees bind recovery to source spacing, sign, noise, and signal class, while learned decoders often hide analogous distributional commitments.
- **Open issue:** perceptual metrics can reward plausible invented detail in evidence-bearing reconstruction.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md), [Candidate 017](../experiments/candidates/017-contract-preserving-semantic-compaction.md), [Candidate 018](../experiments/candidates/018-value-reconstructability-aware-tiering.md).

### C-981

- **Statement:** Measuring many channels together can improve SNR when detector noise dominates, but strong source photon noise can be distributed across recovered channels and remove or reverse that advantage.
- **Status:** established.
- **Primary sources:** `DeckerHarwit1968Hadamard`, `VoigtmanWinefordner1987Multiplex`.
- **Rationale:** multiplex gain is conditional on throughput, detector noise, shot noise, spectrum shape, and decoding matrix.
- **Open issue:** wavelength- and spatial-multiplexed compute claims often omit the source, crosstalk, and receiver-noise regime.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 001](../experiments/candidates/001-adaptive-topology.md).

### C-982

- **Statement:** Coded apertures can provide throughput and field advantages where focusing optics are unavailable, but background, partial coding, finite detector extent, sampling, mask opacity, and decoder mismatch set artifacts and SNR.
- **Status:** established.
- **Primary sources:** `FenimoreCannon1978CodedAperture`, `FenimoreCannon1981URA`.
- **Rationale:** uniformly redundant arrays control autocorrelation sidelobes under stated assumptions without removing photon background or calibration error.
- **Open issue:** learned masks may overfit a scene class or device-specific artifacts.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 006](../experiments/candidates/006-reversible-physical-skill.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md).

### C-983

- **Statement:** Wavefront correction requires sensing or estimating aberration, computing a command, actuating a corrector, and closing the loop faster and more accurately than the relevant disturbance dynamics.
- **Status:** established.
- **Primary sources:** `Babcock1953Seeing`, `LeRouxEtAl2004AOControl`, `CorreiaEtAl2013AOControl`.
- **Rationale:** fitting error, measurement noise, delay, anisoplanatism, actuator limits, and unmodeled dynamics remain despite an accurate nominal inverse.
- **Open issue:** learned predictors may fail abruptly under nonstationary turbulence or mechanical disturbance.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 010](../experiments/candidates/010-reset-coupled-staged-verification.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md).

### C-984

- **Statement:** Image-based adaptive optics can estimate correction without a separate wavefront sensor, but the chosen sharpness or task metric can have local optima, scene dependence, and confounding with object structure.
- **Status:** plausible.
- **Primary sources:** `Booth2007SensorlessAO`, `DebarreEtAl2007ImageAO`, `ThayilEtAl2011SensorlessAO`.
- **Rationale:** metric optimization is effective in scoped microscopes without establishing general task benefit or unique wavefront recovery.
- **Open issue:** a learned task metric can reward hallucinated or class-specific detail while degrading measurement fidelity.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 010](../experiments/candidates/010-reset-coupled-staged-verification.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md).

### C-985

- **Statement:** Jointly estimating a scene and an unknown transfer function introduces scale, shift, factorization, and model ambiguities unless diversity, subspace structure, references, or other constraints restore identifiability.
- **Status:** established.
- **Primary sources:** `AhmedEtAl2014BlindDeconvolution`, `Fienup1993ComplicatedSystem`.
- **Rationale:** self-calibration works under explicit structural conditions; unconstrained fitting can explain error by changing either scene or instrument.
- **Open issue:** large learned priors can conceal rather than resolve the ambiguity.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 010](../experiments/candidates/010-reset-coupled-staged-verification.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md).

### C-986

- **Statement:** Alignment, source intensity, detector response, wavelength, temperature, stress, and aging change the deployed forward operator, so a one-time calibration cannot be presumed valid indefinitely.
- **Status:** established.
- **Primary sources:** `BogaertsChrostowski2018SiliconPhotonics`, `HughesEtAl2018InSituBackprop`, `TeofilovicEtAl2024ThermalCrosstalk`.
- **Rationale:** sensitivity to geometric and thermal variation motivates in-situ measurement and compensation.
- **Open issue:** task residuals can detect change late and cannot localize its physical cause without dedicated probes.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 010](../experiments/candidates/010-reset-coupled-staged-verification.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md).

### C-987

- **Statement:** Clipped pixels and rate-limited photon counters map multiple incident fluxes to indistinguishable outputs; post-processing cannot uniquely recover lost amplitude without another exposure, code, or prior.
- **Status:** established.
- **Primary sources:** `DebevecMalik1997HDR`, `HeideEtAl2018PhotonEfficient3D`, `TaguchiEtAl2013PhotonCounting`.
- **Rationale:** multiexposure HDR changes acquisition, while SPAD pile-up models explicitly account for missed events during dead time.
- **Open issue:** learned HDR may generate plausible highlights whose evidential support comes from a prior rather than measurement.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 007](../experiments/candidates/007-endogenous-observation-surveillance.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md).

### C-988

- **Statement:** Multiple sensors improve inference only when their information is complementary and their timing, frames, calibration, and error dependence are modeled; double-counting correlated evidence creates overconfidence.
- **Status:** established.
- **Primary sources:** `kalman1960filtering`, `julier1997`.
- **Rationale:** optimal linear fusion relies on covariance assumptions, while covariance intersection addresses unknown cross-correlation.
- **Open issue:** neural fusion can conceal modality leakage, timestamp errors, common-mode weather, or shared training-set bias.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md).

### C-989

- **Statement:** Diffraction, interference, Fourier planes, and interferometer meshes can implement structured or programmable linear maps with high physical parallelism and low incremental propagation energy.
- **Status:** established.
- **Primary sources:** `ShenEtAl2017NanophotonicCircuits`, `LinEtAl2018DiffractiveDNN`, `Miller2013UniversalOptical`.
- **Rationale:** the physical map is real, but usefulness remains conditional on source, modulation, detection, precision, loss, programmability, and utilization.
- **Open issue:** nominal operation count for dense wave interference cannot substitute for task throughput or energy.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 001](../experiments/candidates/001-adaptive-topology.md), [Candidate 006](../experiments/candidates/006-reversible-physical-skill.md).

### C-990

- **Statement:** When information already arrives optically and the required task output is low-dimensional, a matched optical or optoelectronic front end can avoid full-frame digitization, memory traffic, or reconstruction.
- **Status:** plausible.
- **Primary sources:** `AshtianiEtAl2022PhotonicDNN`, `ChangEtAl2018HybridOpticalCNN`.
- **Rationale:** direct sensor-to-classifier paths establish a favorable regime, not general superiority; small tasks, fixed operators, and native optical input matter.
- **Open issue:** discarding reconstructable raw data can impair audit, transfer, and recovery when future queries differ.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 006](../experiments/candidates/006-reversible-physical-skill.md), [Candidate 017](../experiments/candidates/017-contract-preserving-semantic-compaction.md), [Candidate 018](../experiments/candidates/018-value-reconstructability-aware-tiering.md).

### C-991

- **Statement:** Sub-photon-per-multiplication and femtojoule optical-operation demonstrations do not by themselves establish lower wall-plug energy per useful inference because source efficiency, fan-out, loss, conversion, control, and digital work can dominate.
- **Status:** disputed.
- **Primary sources:** `WangEtAl2022PhotonMultiplication`, `Miller2017Attojoule`.
- **Rationale:** the component-level physical results are established at their stated boundary; extrapolation to a deployed system is disputed.
- **Open issue:** integrated sources, nonvolatile weights, direct optical input, and low-dimensional output may materially shift the crossover.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 006](../experiments/candidates/006-reversible-physical-skill.md).

### C-992

- **Statement:** DACs, modulators, photodetectors, transimpedance amplifiers, ADCs, serialization, and memory are functional parts of a photonic accelerator; their energy and bandwidth generally depend on sample rate, precision, and channel count.
- **Status:** established.
- **Primary sources:** `XuEtAl2019PhotonicADC`, `HamerlyEtAl2019OpticalNN`, `NahmiasEtAl2020PhotonicMAC`.
- **Rationale:** optical linear algebra surrounded by electronic encoding and readout is a hybrid system whose precision changes both cost and model quality.
- **Open issue:** converter sharing and analog accumulation may reduce conversions while increasing noise, fan-in range, latency, or inflexibility.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 006](../experiments/candidates/006-reversible-physical-skill.md), [Candidate 017](../experiments/candidates/017-contract-preserving-semantic-compaction.md).

### C-993

- **Statement:** Loss, phase error, amplitude error, shot noise, detector noise, crosstalk, and quantization perturb analog optical computations; cascaded layers require a measured error and gain budget.
- **Status:** established.
- **Primary sources:** `ShenEtAl2017NanophotonicCircuits`, `HamerlyEtAl2019OpticalNN`, `FeldmannEtAl2021TensorCore`.
- **Rationale:** useful tolerance at one proof-of-concept scale does not imply precision or cascadability independent of depth and fan-in.
- **Open issue:** error-aware training may absorb stationary mismatch while reducing margin to drift and distribution shift.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 006](../experiments/candidates/006-reversible-physical-skill.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md).

### C-994

- **Statement:** Waveguide dimensions, thickness, refractive index, couplers, resonators, and phase shifters vary across dies and wafers, perturbing transfer functions and yield.
- **Status:** established.
- **Primary sources:** `BogaertsChrostowski2018SiliconPhotonics`, `ChrostowskiHochberg2015Fabrication`.
- **Rationale:** design-for-manufacture, trimming, tuning, and calibration exist because the ideal layout is not the deployed operator.
- **Open issue:** selected-device reports often omit yield distributions, packaging, and replacement costs.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 006](../experiments/candidates/006-reversible-physical-skill.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md).

### C-995

- **Statement:** Thermo-optic tuning can correct or program photonic circuits, but consumes static or dynamic power, shifts neighboring elements, and adds a temperature-dependent control problem.
- **Status:** established.
- **Primary sources:** `BogaertsChrostowski2018SiliconPhotonics`, `HarrisEtAl2014ThermoOptic`, `TeofilovicEtAl2024ThermalCrosstalk`.
- **Rationale:** measured phase-shifter power and thermal crosstalk show that reconfiguration is not a free metadata update.
- **Open issue:** nonvolatile and electro-optic alternatives exchange static power for write energy, loss, area, endurance, integration, or drive voltage.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 001](../experiments/candidates/001-adaptive-topology.md), [Candidate 006](../experiments/candidates/006-reversible-physical-skill.md).

### C-996

- **Statement:** Measuring gradients or optimizing directly on a physical photonic system can reduce dependence on an exact digital twin and compensate some static device error.
- **Status:** plausible.
- **Primary sources:** `HughesEtAl2018InSituBackprop`, `PaiEtAl2023InSituBackprop`.
- **Rationale:** physical-gradient protocols work in scope without eliminating readout, data, perturbation, control, drift, or convergence costs.
- **Open issue:** online adaptation may overwrite a validated state or fit transient noise unless bounded and versioned.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 010](../experiments/candidates/010-reset-coupled-staged-verification.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md).

### C-997

- **Statement:** Optical excitability, spikes, wavelength broadcast, or laser dynamics can implement useful temporal transforms, but neuron-like terminology alone does not demonstrate better learning, control, accuracy, or energy than conventional photonic signal processing and digital recurrent models.
- **Status:** disputed.
- **Primary sources:** `TaitEtAl2014BroadcastWeight`, `FeldmannEtAl2019Spiking`, `ShastriEtAl2021PhotonicsAI`.
- **Rationale:** real device dynamics and networks do not make biological naming a computational advantage.
- **Open issue:** whether tasks aligned to native device dynamics leave a residual after matched reservoir, DSP, and digital-spiking baselines.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 006](../experiments/candidates/006-reversible-physical-skill.md).

### C-998

- **Statement:** A hybrid scheduler can benefit by routing stable, dense, high-reuse linear transforms with native optical input to photonics while retaining sparse, precise, rapidly changing, control-heavy, or audit-critical work in digital paths.
- **Status:** plausible.
- **Primary sources:** `XuEtAl2021PhotonicConvolution`, `FeldmannEtAl2021TensorCore`, `AshtianiEtAl2022PhotonicDNN`.
- **Rationale:** demonstrations identify favorable regimes, while configuration, conversion, utilization, and precision determine the crossover.
- **Open issue:** routing overhead and workload prediction may erase gains for short or nonstationary jobs.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 001](../experiments/candidates/001-adaptive-topology.md), [Candidate 006](../experiments/candidates/006-reversible-physical-skill.md).

### C-999

- **Statement:** An optical front end can reduce digitized data and downstream arithmetic when it computes a sufficient task statistic before conversion, but it may destroy information needed for audit, adaptation, or future tasks.
- **Status:** plausible.
- **Primary sources:** `ChangEtAl2018HybridOpticalCNN`, `LinEtAl2018DiffractiveDNN`, `AshtianiEtAl2022PhotonicDNN`.
- **Rationale:** task-specific optical processing is lossy compilation whose value depends on the query set and reconstructability obligation.
- **Open issue:** sufficiency under one training distribution can fail after task or environmental change.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 006](../experiments/candidates/006-reversible-physical-skill.md), [Candidate 017](../experiments/candidates/017-contract-preserving-semantic-compaction.md), [Candidate 018](../experiments/candidates/018-value-reconstructability-aware-tiering.md).

### C-1000

- **Statement:** One confidence scalar is insufficient for inverse sensing because observation noise, null-space ambiguity, prior extrapolation, calibration uncertainty, and temporal drift call for different interventions.
- **Status:** plausible.
- **Primary sources:** `KaipioSomersalo2005InverseProblems`, `AhmedEtAl2014BlindDeconvolution`, `TsangEtAl2016QuantumSuperresolution`.
- **Rationale:** another photon, changed geometry, recalibration, and a better prior address different uncertainty sources.
- **Open issue:** scalable decomposition for large learned inverse models remains an engineering and statistical challenge.
- **Used by:** [optics audit](audits/2026-08-05-optics-photonics-inverse-sensing.md), [Fixture F-007](../experiments/fixtures/007-operator-qualified-optical-inference.md), [Candidate 007](../experiments/candidates/007-endogenous-observation-surveillance.md), [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md).

### C-1001

- **Statement:** Source, conversion, control, thermal stabilization, cooling, calibration, utilization, yield, package, and embodied manufacture can change the energy ranking inferred from a passive optical core.
- **Status:** established.
- **Primary sources:** `WilliamsEtAl2002Microchip`, `BogaertsChrostowski2018SiliconPhotonics`, `WangEtAl2022PhotonMultiplication`.
