...
| Plant stress and systemic signaling | priming, distributed alarm, hydraulic/chemical control, resource allocation, growth, transport | P-001, P-003, P-005, P-006, P-009, P-010, P-011, P-012, P-013 plus held deficit–capability routing | partial; [plant audit](audits/2026-08-05-plant-distributed-control.md) | seasonal memory, non-Arabidopsis variation, field-scale path identification, full growth/transport energy |
| Fungal and mycorrhizal networks | frontier exploration, fusion, trade, transport | [P-005](principle-registry.md#p-005--use-dependent-topology), [P-007](principle-registry.md#p-007--prediction-error-allocation) | partial; [fungal-network audit](audits/2026-08-05-fungal-networks-resource-allocation.md); next: prospective in-flight-inventory topology tests, three-dimensional transport, partner-specific fitness, and replicated priming/memory controls |
...
| Bacteria and microbial collectives | bet hedging, quorum, dormancy, horizontal transfer | [P-004](principle-registry.md#p-004--diversity-selection-and-protection) | partial; [microbial-ecology/biofilm audit](audits/2026-08-05-microbial-ecology-biofilms.md); next: transport-explicit coordination benchmark, mechanism-resolved tolerance, lineage-aware transfer, and adaptive phage-defense tests |
| Regeneration and morphogenesis | target-state repair and positional memory | [P-006](principle-registry.md#p-006--homeostatic-negative-feedback), [P-009](principle-registry.md#p-009--maintenance-plane) | partial; [developmental/morphogenesis audit](audits/2026-08-05-developmental-morphogenesis.md) | bioelectric target states, salamander limb repair, cancer suppression |
...
| Development and morphogenesis | embryology, tissue patterning, wound repair, metamorphosis | staged commitment, positional state, self-construction, reversible plasticity | partial; [developmental/morphogenesis audit](audits/2026-08-05-developmental-morphogenesis.md); next: quantitative in-vivo competence windows, energetic budgets, regeneration failure, and cross-system fixture implementation |
...
| Chemistry and reaction networks | catalysis, autocatalysis, reaction–diffusion, self-assembly | constrained search, local computation, pattern formation, kinetic proofreading | partial; [chemistry audit](audits/2026-08-05-chemistry-reaction-networks-proofreading.md); next: spatial nonequilibrium networks, fabrication lifecycle, and real sensor–actuator boundaries |
