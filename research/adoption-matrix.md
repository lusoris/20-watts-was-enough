...
| Latency-qualified authority envelopes | Shrink or widen admissible action from evidence age, integrity, mode, physical headroom, and coordination, with independent limits and validated handoff | **Experiment** | primary/backup protection, adaptive settings, supervisory and constrained control, barrier functions, runtime assurance, restoration runbooks | [Candidate 012](../experiments/candidates/012-latency-qualified-authority.md) must improve service and risk across stale data, saturation, common-mode fault, communication loss, partition, and recovery at equal reserve and authority | [C-186](claims.md#c-186)–[C-203](claims.md#c-203) |
...
| Versioned, support-qualified observation contracts | Carry response, calibration, spatial support, integration window, latency, resolution, preservation, intervention, selection, association, uncertainty, vintage, supersession, and permitted follow-up with each derived claim | **Experiment** | typed evidence schema, event-time metadata, hierarchical state-space or Gaussian-process model, calibrated likelihood, selection model, lineage, multiplicity control, predictive checks, simulation calibration, graded assurance, surveillance schema, value-of-information scheduling | [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md) must reduce overconfidence, invalid mixed-clock fusion, false association, selection error, stale claims, and wasted follow-up at equal sensor, compute, storage, review, latency, and energy budgets | [C-218](claims.md#c-218)–[C-249](claims.md#c-249) |
