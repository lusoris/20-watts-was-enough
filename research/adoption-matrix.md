...
| Versioned observation contracts | Carry response, calibration, exposure, selection, association, uncertainty, vintage, supersession, and permitted follow-up with each derived claim | **Experiment** | typed evidence schema, calibrated likelihood, selection model, lineage, multiplicity control, predictive checks, simulation calibration, graded assurance, surveillance schema, value-of-information scheduling | [Candidate 014](../experiments/candidates/014-versioned-observation-contract.md) must reduce overconfidence, false association, selection error, stale claims, and wasted follow-up at equal sensor, compute, storage, review, latency, and energy budgets | [C-218](claims.md#c-218)–[C-231](claims.md#c-231) |
